...
def train(
    ...
    if hasattr(xgb, "save_model"):
        ...
        joblib.dump(xgb, SETTINGS.models_dir / "xgboost_cd_model.joblib")
    ...
    try:
        ...
        LOGGER.warning("SHAP summary figure not written (see exception below).", exc_info=True)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-out", type=Path, default=SETTINGS.xgboost_model_path)
