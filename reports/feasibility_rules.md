...
| `PKG_005` | Wheelbase-to-length ratio must stay within a plausible range. |
| `PKG_006` | Hood/roof height proxy must not fall below the baseline envelope tolerance. |
